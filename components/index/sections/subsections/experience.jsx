    ...
    <div id={props.id} className={props.class}>
        ...
        <div className="resume-wrap d-flex ftco-animate">
            ...
            <div className="text pl-3">
                ...
                <p>
                Participating in projects like <a href="https://www.rebuildeurope.eu/en/default.aspx" target="_blank">Rebuild</a>, <a href="https://fandango-project.eu/" target="_blank">Fandango</a> and <a href="https://www.video-mos.com" target="_blank">VideoMOS</a>.
                <br/>
        ...
        <div className="resume-wrap d-flex ftco-animate">
            ...
            <div className="text pl-3">
                ...
                <br/>
                    <a href="http://www.nrg5.eu/aerial-predictive-maintenance-for-utility-infrastructures/" target="_blank">NRG 5</a> Developed a predictive maintenance state-of-the-art solution using drone imagery and <strong>deep learning algorithms.</strong>
                <br/>
                    <a href="https://visiona-ip.es/servicios/avvpark/" target="_blank">AVVPark</a> Automatic occupancy detection system for parking using CCTV Cameras processed with <strong> OpenCV and TensorFlow.</strong>
                <br/>
                    <a href="https://visiona-ip.es/servicios/scopia/" target="_blank">ScopIA Media</a> <strong>Microservices</strong> based on Deep Learning for multiple applications: <strong>Gender Detection, Content Moderation and Object Detection.</strong>
                </p>   
                <p>
